...
const getIcon = (iconName: string) => {
    const icons = {
        phone: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.037 11.037 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z',
        email: 'M2 5h20v14H2zM2 5l10 7 10-7M2 19l7.5-5.5L22 19l-7.5-5.5M2 4h20v16H2z M2 4l10 8 10-8M2 4 H22 V20 H2 L2 4 M2 4 L12 12 L22 4',
    ...
    return icons[iconName as keyof typeof icons] || icons.phone;
};
</script>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    >
                        <div class="w-16 h-16 bg-accent/10 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:bg-accent group-hover:text-white transition-all duration-300">
                            <svg class="w-8 h-8 text-accent group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
