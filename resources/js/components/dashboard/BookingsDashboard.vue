...
const getStatusClass = (status: string) => {
    const classes = {
        ...
        withdrawn: 'bg-purple-100 text-purple-800 dark:bg-purple-900/20 dark:text-purple-300',
    };
...
const getSourceClass = (source: string) => {
    const classes = {
        direct: 'bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-300',
        airbnb: 'bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-300',
        booking_com: 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/20 dark:text-indigo-300',
        agoda: 'bg-orange-100 text-orange-800 dark:bg-orange-900/20 dark:text-orange-300',
    };
    return classes[source as keyof typeof classes] || 'bg-gray-100 text-gray-800 dark:bg-gray-900/20 dark:text-gray-300';
};
